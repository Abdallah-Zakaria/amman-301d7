...
// this here is a keyword refers to the object joe it belongs to
// 2. What is "this" when joe.scopeArrow() is invoked?
// With arrow functions the this keyword always represents the object that defined the arrow function.
// 3. Explain why "this" is different when an arrow function is used.
// Because the 'this' is interpreted as 'undefined' because an arrow function automatically binds the context, here we you should use a regular function() or use the arrow syntax in the constructor directly.
